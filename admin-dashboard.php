...
// Validating session integrity (e.g., checking user agent to detect session hijacking)
...
<body>
  ...
  <script>
    ...
    const inactivityTimeout = <?php echo $inactivity_timeout; ?> * 1000; // 5 minutes in milliseconds
    const maxSessionDuration = <?php echo $max_session_duration; ?> * 1000; // 30 minutes in milliseconds
    const warningTime = <?php echo $warning_time; ?> * 1000; // 1 minute in milliseconds
    ...
    // Extend session on button click
