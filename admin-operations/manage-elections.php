<?php
// File: admin-operations/manage-elections.php
session_start();
...
<head>
    ...
    <title>Election Management | SmartUchaguzi</title>
...
<body>
    ...
    <aside class="sidebar">
        <div class="nav">
            ...
            <a href="manage-elections.php" class="active"><i class="fas fa-cog"></i> Election Management</a>
        ...
        <section class="dashboard">
            <div class="dash-content">
                ...
                <div class="action-buttons">
                    <button onclick="window.location.href='add-election.php'">Add Election</button>
                    <button onclick="window.location.href='edit-election.php'">Edit Election</button>
