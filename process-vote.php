        ...
        form.addEventListener('submit', async (e) => {
            ...
            confirmButton.onclick = async () => {
                ...
                try {
                    ...
                    if (!fraudResponse.ok) throw new Error(`Fraud detection API failed: ${fraudResponse.statusText}`);
                    ...
                    if (!result.success) throw new Error('Failed to log vote in database: ' + result.message);
